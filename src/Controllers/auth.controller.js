...
const newToken = (user) => {
  return jwt.sign(
    { user: user },
    "gsfgsfgduskjghskjhgsduagseuiwahgwiesuytuiyshwtuwyurtwhnfiow"
  )
}
...
const register = async (req, res) => {
  try {
    ...
    const url = `https://ikeaserver.herokuapp.com/confrimation/${token}`

    const mailOptions = {
      from: "ikeaseverclone@gmail.com", // sender address
